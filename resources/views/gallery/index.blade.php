                ...
                <div class="col">
                  <form>
                    <div class="row align-items-center ">
                      <div class="col">
                        <input type="search" class="form-control" placeholder="Find images here" name="search"
                          value="{{ request('search') }}">
                      </div>
                      <div class="col-sm-2">
                        <a href="{{url('/gallerylist')}}" title="gallery"><i class="btn btn-primary">Clear
                            search</i></a>
                      </div>
                    </div>
                  </form>
                  ...
                  <div class="card card-chart">
                    ...
                    <div class="card-body">
                      <div class="chart-area">
                        <img src="{{ asset('assets/img/gallery/' .$item->image) }}" class="card-img-top"
                          alt="{{ $item->image }}" style="object-fit: cover; width: 100%; height: 250px;">
                      </div>
                    </div>
